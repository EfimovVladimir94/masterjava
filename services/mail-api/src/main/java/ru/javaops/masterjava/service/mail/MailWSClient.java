...
public class MailWSClient {
    ...
    public static String sendToGroup(final Set<Addressee> to, final Set<Addressee> cc, final String subject, final String body) {
        ...
        log.info("Send to group status: " + status);
        return status;
    }
    ...
    public static GroupResult sendBulk(final Set<Addressee> to, final String subject, final String body) {
        ...
        log.info("Send bulk with result: " + result);
        return result;
    }

    public static Set<Addressee> splitter(String addressee) {
        Iterable<String> split = Splitter.on(',').trimResults().omitEmptyStrings().split(addressee);
